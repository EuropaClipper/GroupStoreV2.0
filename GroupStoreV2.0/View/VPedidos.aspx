<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VPedidos.aspx.cs" Inherits="View_VPedidos" %>
            ...
            <div id="layoutSidenav_content">
                <main class="px-1">
                    <div class="container-fluid mt-3">
                        <div class="row">
                            <span class="h2 text-center">Pedidos pendientes</span>
                        </div>
                        <div class="row">
                            <div runat="server" class="container-fluid" id="tarjetasPedidos"></div>
                        </div>
                    </div>
                </main>
